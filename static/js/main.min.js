!function () {
    ...
    var e, i, n, o, s, a, r, l, c = {
        ...
        minipopup: {
            ...
            action: '<a href="panier" class="btn viewcart">Mon Panier</a><a href="checkout.html" class="btn btn-dark checkout">Checkout</a>',
            delay: 4e3,
            space: 20,
        ...
        init: function () {
            this.initialised || (this.initialised = !0, this.checkMobile(), this.stickyHeader(), this.headerSearchToggle(), this.mMenuIcons(), this.mMenuToggle(), this.mobileMenu(), this.scrollToTop(), this.quantityInputs(), this.alert(), this.countTo(), this.tooltip(), this.popover(), this.changePassToggle(), this.changeBillToggle(), this.catAccordion(), this.toggleFilter(), this.toggleSidebar(), this.toggleCart(), this.linkToTab(), this.productTabSroll(), this.scrollToElement(), this.productManage(), this.ratingTooltip(), this.windowClick(), this.popupMenu(), this.topNotice(), this.ratingForm(), this.parallax(), this.sideMenu(), this.miniPopup.init(), this.initProductSinglePage(), this.initCollapsibleWidget(), this.initProductsScrollLoad(".scroll-load"), this.productsCartAction(), this.productsWishlistAction(), this.initPurchasedMinipopup(), this.initJqueryParallax(), this.ajaxLoadProducts(), this.categoryNavScroll(), this.wordRotate(), this.footerReveal(), this.videoModal(), this.animPlayBtn(), t.fn.superfish && this.menuInit(), t.fn.countdown && this.countDown(), t.fn.owlCarousel && this.owlCarousels(), "object" == typeof noUiSlider && this.filterSlider(), t.fn.themeSticky && this.stickySidebar(), t.fn.magnificPopup && this.lightBox(), t.fn.isotope && this.isotopes(), t.fn.elevateZoom && this.zoomImage(), t.fn.themePluginFloatElement && this.floatElement())
        },
        ...
        productsCartAction: function () {
            t("body").on("click", ".btn-add-cart.product-type-simple", function (e) {
                ...
                var i = t(this).closest(".product-default").length > 0 ? t(this).closest(".product-default") : t(this).closest(".product-row");
                ...
                // If there is no form, get the href attribute from the anchor tag
                var link = t(this).attr('href')

        if (link === undefined) {
            var form = $(this).closest('form')
            console.log(form)
            // Wait for 4 seconds (4000 milliseconds) before submitting the form
            setTimeout(function () {
                form.submit();
            }, 4000);
        } else {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            // Update UI to reflect that the product has been added to the cart
